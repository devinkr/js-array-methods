...
-   Describe the relationship between higher-order functions and callback functions
...
but looping syntax can difficult read and reason
...
developer toolkit, with the additional benefit that they can be
in arrays easier. These methods can also be more powerful than
easier to read and more intuitive to use.
...
...especially if we convert this to the arrow syntax:
...
```js
const programmingLanguages = ['JavaScript', 'Python', 'Rails', 'Java', 'C#', 'C++']
